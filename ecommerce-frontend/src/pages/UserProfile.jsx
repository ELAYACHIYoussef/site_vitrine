                ...
                >
                    <div className="h-32 bg-gradient-to-r from-indigo-600 to-violet-600 relative">
                        <div className="absolute -bottom-16 left-8">
                            ...
                            >
                                <div className="w-32 h-32 rounded-full border-4 border-white bg-slate-100 flex items-center justify-center overflow-hidden shadow-lg group-hover/avatar:shadow-xl transition-shadow duration-300">
                                    <User className="w-16 h-16 text-slate-400 group-hover/avatar:scale-110 transition-transform duration-500" />
                                </div>
                                <motion.button

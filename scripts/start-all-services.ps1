...
Write-Host "[1/5] Starting Eureka Server (Discovery)..." -ForegroundColor Cyan
...
# Start API Gateway
Write-Host "[2/5] Starting API Gateway..." -ForegroundColor Yellow
...
Write-Host "[3/5] Starting Catalog Service..." -ForegroundColor Magenta
Start-Process powershell -ArgumentList "-NoExit", "-File", "$basePath\start-catalog.ps1"
Write-Host "  Waiting 10 seconds..." -ForegroundColor Gray
Start-Sleep -Seconds 10

# Start Auth Service
Write-Host "[4/5] Starting Auth Service..." -ForegroundColor Blue
Start-Process powershell -ArgumentList "-NoExit", "-File", "$basePath\start-auth.ps1"
Write-Host "  Waiting 10 seconds..." -ForegroundColor Gray
Start-Sleep -Seconds 10

# Start Order Service
Write-Host "[5/5] Starting Order Service..." -ForegroundColor Cyan
Start-Process powershell -ArgumentList "-NoExit", "-File", "$basePath\start-order.ps1"

Write-Host ""
Write-Host "==========================================" -ForegroundColor White -BackgroundColor DarkGreen
Write-Host "  ALL 5 SERVICES STARTED!" -ForegroundColor White -BackgroundColor DarkGreen
Write-Host "==========================================" -ForegroundColor White -BackgroundColor DarkGreen
Write-Host ""

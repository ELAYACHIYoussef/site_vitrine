...
public class Product {
    ...
    public void setInstagramMediaId(String instagramMediaId) {
    ...
    public static class ProductBuilder {
        ...
        public ProductBuilder videoUrl(String videoUrl) {
        ...
        public ProductBuilder createdAt(java.time.LocalDateTime createdAt) {
            ...
            // Wait, CreatedAt is usually managed by JPA, but builder might want it for
            // tests.
            // Product.java has @Column(name="created_at") private LocalDateTime createdAt;
            // Did I add setCreatedAt? Step 1183 shows NO manual setters for
            // createdAt/updatedAt.
            ...
            // I will skip createdAt/updatedAt for builder for now, assuming they are not
            // used in builder.
            return this;
        }
